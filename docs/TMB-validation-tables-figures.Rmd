...
```{r, randomwalk-results, echo = FALSE, message = FALSE, warning = FALSE, fig.width = 8, fig.cap = "Simple Mixed Model. Type I error rates and Power evaluated for each analytical and simulation method. Results are partitioned out by residual type (top to bottom)."}
res.methods <- c(
   'full Gaussian',
   'one-step Gaussian',
   'one-step Generic',
